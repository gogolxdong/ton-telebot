...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.JettonWalletAddress = field.NewString(tableName, "jetton_wallet_address")
	_user.PrivateKey = field.NewString(tableName, "private_key")
	_user.Mnemonic = field.NewString(tableName, "mnemonic")
...
type user struct {
	...
	UserName            field.String // 电报用户名
	JettonWalletAddress field.String // jetton钱包地址
	PrivateKey          field.String // TON钱包私钥
...
func (u *user) updateTableName(table string) *user {
	...
	u.JettonWalletAddress = field.NewString(table, "jetton_wallet_address")
	u.PrivateKey = field.NewString(table, "private_key")
	u.Mnemonic = field.NewString(table, "mnemonic")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["jetton_wallet_address"] = u.JettonWalletAddress
	u.fieldMap["private_key"] = u.PrivateKey
	u.fieldMap["mnemonic"] = u.Mnemonic
