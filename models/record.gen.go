...
func newRecord(db *gorm.DB, opts ...gen.DOOption) record {
	...
	_record.UID = field.NewInt64(tableName, "uid")
	_record.JettonWalletAddress = field.NewString(tableName, "jetton_wallet_address")
	_record.Transaction = field.NewString(tableName, "transaction")
	_record.CreateTime = field.NewTime(tableName, "create_time")
	_record.UpdateTime = field.NewTime(tableName, "update_time")
...
type record struct {
	...
	ALL                 field.Asterisk
	ID                  field.Int32  // id
	UID                 field.Int64  // 电报用户ID
	JettonWalletAddress field.String // jetton钱包地址
	Transaction         field.String // 交易
...
func (r *record) updateTableName(table string) *record {
	...
	r.JettonWalletAddress = field.NewString(table, "jetton_wallet_address")
	r.Transaction = field.NewString(table, "transaction")
...
func (r *record) fillFieldMap() {
	...
	r.fieldMap["jetton_wallet_address"] = r.JettonWalletAddress
	r.fieldMap["transaction"] = r.Transaction
